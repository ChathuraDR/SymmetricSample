...
public class main extends javax.swing.JFrame {
    ...
    testFileHandler th = new testFileHandler();
    public main() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        plainTextField.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                plainTextFieldPropertyChange(evt);
            }
        });
    ...
    private void btnDecryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDecryptActionPerformed
        if(key1.getPassword().length == 0){
            ...
            //if only those filed arn't empty then get the key as a sting and pass it to the decrypt function with the variable name of the text field that we want to set the decrypted text to.
            String s = new String(key1.getPassword());
            try {
                th.decrypt(ciphertextField.getText().toString(),s, plainTextField);
            } catch (Exception ex) {
    ...
    private void plainTextFieldPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_plainTextFieldPropertyChange
    ...
    private void btnEncryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEncryptActionPerformed
        if(key.getPassword().length == 0 || keyConfirm.getPassword().length == 0){
            ...
            //if those field arn't empty then check whether those passwords are match.
            ...
            //if password fields ok then check the texFields if there's any text.if not nothing to encrypt,then tell it to the user. 
            ...
            try {
                th.encrypt(plainTextField.getText().toString(), s, ciphertextField);  //pass to the encrypt function to encrypt.
            } catch (Exception ex) {
